...
pop {R0}
MOV R1, R0
MOV R0, #9      @load addres for variable
push {R0}         @stack result content
pop {R0}
MOV R2, R0
CMP R1, R2
...
L6:      @label for endif
L3:      @label for endif
LDR R0, =string_5           @load addres of pattern number
BL printf      @call function for write
pop {ip, pc}
.data
.balign 8
...
.balign 8
string_3: .asciz "Exame"
.balign 8
string_4: .asciz "Reprovado"
.balign 8
string_5: .asciz "SUCESSO!"
.global printf
.global scan
