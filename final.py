    ...
    def inicia_geracao(self):
        ...
        for line in  self.codigo_intermediario:
            ...
            if line.split()[0] == 'leia':
                ...
                self.codigo_final.append("BL print      @call function for write")
                    
            elif line.split()[0] == 'se':
                label = self.getLabel()
                label_else: self.getLabel()
                if len(line.split()>4):
                    print("Possui conector lógico AND e OU")                            
                else:
